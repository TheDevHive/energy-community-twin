...
public class ApartmentDAOTest {
    ...
    public void testSaveOrUpdate_InsertNewApartment() throws SQLException {
        ...
        apartment.setId(0);
        apartment.setResidents(3);
        apartment.setSquareFootage(100);
        apartment.setEnergyClass("A");
        apartment.setBuilding(mockBuilding);
        apartment.setUser(mockUser);

        when(mockBuilding.getId()).thenReturn(1);
        when(mockUser.getId()).thenReturn(1);

        ApartmentDAO spyApartmentDAO = Mockito.spy(apartmentDAO);
    ...
    public void testFindByPrimaryKey_Found() throws SQLException {
        ...
        when(mockResultSet.next()).thenReturn(true);
        when(mockResultSet.getInt("id")).thenReturn(apartmentId);
        ...
        try (MockedStatic<DBManager> mockedDBManager = Mockito.mockStatic(DBManager.class)) {
            ...
            assertEquals(apartmentId, resultApartment.getId());
